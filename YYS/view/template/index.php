        ...
        <div class="card">
            <div class="card-body">
                <div style="width: 100%;">
                    ...
                    <a class="btn btn-primary mb-3" style="float:right;" href="../list/index.php?view=show1"
                       role="button">查看页面</a>
                        ...
                        if (!$.isEmptyObject(data)) {
                            ...
                            if (data.hasOwnProperty("data")) {
                                ...
                                for (var k in data.data) {
                                    ...
                                    html += '<tr id="sid_' + data.data[k].id + '">';
                                    ...
                                    for (var ks in tmps) {
                                        ...
                                        if (ks == 'id') {
                                            ...
                                            console.log(parent_like,ssd);
                                            for (var item in parent_like) {

                                                if (ssd.hasOwnProperty(item)) {
                                                    tmpdata.push(ssd[item]);
                                                }
                                            }
                                    ...
                                    if ($("#sid_" + data.data[k].id).length > 0) {
                                        $("#sid_" + data.data[k].id).after(html);
                                    } else {
